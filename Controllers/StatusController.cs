...
namespace Task_Managemenet.Controllers
{
    public class StatusController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "StatusID,StatusType")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "StatusID,StatusType")] Status status)
        {
            if (ModelState.IsValid)
            {
